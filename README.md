<body>
  ...
  <ul>
    <li>Web Framework</li>
    <li>Django 3.x (Python 3.8)</li>
    <li>서비스 배포 환경</li>
    <li>Amazon Lightsail ...중략...</li>
  </ul>
 
  <h3>2-2 배포 URL</h3>
  <ul><li>https://www.studyin.co.kr/</li></ul>
  ...
  <h3>3-2 개발 일정(WBS)</h3>
  <ul>
    <li>일정표는 habitmaker.co.kr 에서 작성되었습니다.</li>
